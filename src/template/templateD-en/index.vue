      ...
      <div class="header-content">
        <div class="header-main">
          ...
          <div class="basic-info">
            ...
            <span v-if="resume.personalInfo.age">{{ resume.personalInfo.age }}</span>
          ...
          <div v-if="resume.personalInfo.applicationPosition" class="job-target">
            Target Position: {{ resume.personalInfo.applicationPosition }}
          </div>
        </div>
        <div v-if="resume.personalInfo.avatar" class="avatar">
          <img :src="resume.personalInfo.avatar" alt="Avatar">
        </div>
      </div>
    </header>
    ...
    <section v-if="resume.education.length" class="resume-section">
      ...
      <div class="section-content">
        <div v-for="edu in resume.education" :key="edu.id" class="education-item">
          ...
          <div v-if="edu.startDate" class="edu-time">{{ edu.startDate }} ~ {{ edu.endDate || 'Present' }}</div>
        </div>
      </div>
    </section>
      ...
      <div class="section-content">
        <div v-for="work in resume.workExperience" :key="work.id" class="work-item">
          <div class="work-header">
            ...
            <span v-if="work.startDate" class="time">{{ work.startDate }} ~ {{ work.endDate || 'Present' }}</span>
          </div>
      ...
      <div class="section-content">
        <div v-for="project in resume.projects" :key="project.id" class="project-item">
          <div class="project-header">
            ...
            <span v-if="project.startDate" class="time">{{ project.startDate }} ~ {{ project.endDate || 'Present' }}</span>
          </div>
