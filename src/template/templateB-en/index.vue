      ...
      <div class="personal-info">
        ...
        <div class="info-grid">
          <div class="info-item" v-if="resume.personalInfo.gender">
            <span class="label">Gender:</span>{{ resume.personalInfo.gender }}
          </div>
          <div class="info-item" v-if="resume.personalInfo.age">
            <span class="label">Age:</span>{{ resume.personalInfo.age }}
          </div>
          <div class="info-item" v-if="resume.personalInfo.politicalStatus">
            <span class="label">Political Status:</span>{{ resume.personalInfo.politicalStatus }}
          </div>
          <div class="info-item" v-if="resume.personalInfo.phone">
            <span class="label">Phone:</span>{{ resume.personalInfo.phone }}
          </div>
          <div class="info-item" v-if="resume.personalInfo.email">
            <span class="label">Email:</span>{{ resume.personalInfo.email }}
          </div>
          <div class="info-item" v-if="resume.personalInfo.university">
            <span class="label">School:</span>{{ resume.personalInfo.university }}
          </div>
          <div class="info-item" v-if="resume.personalInfo.major">
            <span class="label">Major:</span>{{ resume.personalInfo.major }}
          </div>
      ...
      <div class="experience-list">
        <div class="experience-item" v-for="edu in resume.education" :key="edu.id">
          <div class="item-header">
            ...
            <span v-if="edu.startDate" class="duration">{{ edu.startDate }} - {{ edu.endDate || 'Present' }}</span>
          </div>
      ...
      <div class="experience-list">
        <div class="experience-item" v-for="work in resume.workExperience" :key="work.id">
          <div class="item-header">
            ...
            <span v-if="work.startDate" class="duration">{{ work.startDate }} - {{ work.endDate || 'Present' }}</span>
          </div>
      ...
      <div class="experience-list">
        <div class="experience-item" v-for="project in resume.projects" :key="project.id">
          <div class="item-header">
            ...
            <span v-if="project.startDate" class="duration">{{ project.startDate }} - {{ project.endDate || 'Present' }}
              </span>
          </div>
...
.list, .skill-list, .description-list {
  list-style: none;
  padding: 0;
  margin: 0;
}

.list li, .skill-list li, .description-list li {
  padding-left: 18px;
  position: relative;
...
.institution, .position, .project-name {
  font-size: 1rem;
}
