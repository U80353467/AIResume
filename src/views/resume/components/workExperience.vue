        ...
        >
          ...
          <a-form layout="vertical">
            ...
            <a-row gutter="24" style="margin-top: 16px">
              <a-col :span="12">
                <a-date-picker v-model:value="work.startDate" placeholder="开始时间" style="width: 100%" picker="month"
                               format="YYYY-MM" value-format="YYYY-MM"  />
              </a-col>
              <a-col :span="12">
                <a-date-picker v-model:value="work.endDate" placeholder="结束时间" style="width: 100%" picker="month"
                               format="YYYY-MM" value-format="YYYY-MM" />
              </a-col>
            </a-row>
